...
import RoomsReducer from "../../src/reducers/room_reducer";

describe("room_reducer", () => {
    const initialState = RoomsReducer(undefined, {});
    ...
    describe("default action", () => {
        const newState = RoomsReducer(initialState, {});
