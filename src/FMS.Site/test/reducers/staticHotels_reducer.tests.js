...
import StaticHotelsReducer from "../../src/reducers/staticHotels_reducer";

describe("hotels_reducer", () => {
    const initialState = StaticHotelsReducer(undefined, {});
    ...
    describe("default action", () => {
        const newState = StaticHotelsReducer(initialState, {});
    ...
    describe("fetchRequestPending action", () => {
        ...
        const newState = StaticHotelsReducer(initialState, action);
