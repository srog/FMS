...
import { HOTELS_GET } from "../../src/constants/actionConstants";
...
describe("hotel_actions", () => {
    describe("getRequestPending", () => {
        ...
        it("should have the expected type", () => {
            expect(action.type).to.equal(`${HOTELS_GET}_${PENDING_SUFFIX}`);
        });
    });
    ...
    describe("getRequestSuccess", () => {
        ...
        it("should have the expected type", () => {
            expect(action.type).to.equal(`${HOTELS_GET}_${SUCCESS_SUFFIX}`);
        });
    });
    ...
    describe("getRequestError", () => {
        ...
        it("should have the expected type", () => {
            expect(action.type).to.equal(`${HOTELS_GET}_${ERROR_SUFFIX}`);
        });
    });
});