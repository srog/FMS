...
import { STATICHOTELS_GET } from "../../src/constants/actionConstants";
import { PENDING_SUFFIX, SUCCESS_SUFFIX, ERROR_SUFFIX } from "../../src/constants/reduxConstants";
import * as Actions from "../../src/actions/staticHotels_actions";
...
describe("hotel_actions", () => {
    describe("getRequestPending", () => {
        ...
        it("should have the expected type", () => {
            expect(action.type).to.equal(`${STATICHOTELS_GET}_${PENDING_SUFFIX}`);
        });
    });
    ...
    describe("getRequestSuccess", () => {
        ...
        it("should have the expected type", () => {
            expect(action.type).to.equal(`${STATICHOTELS_GET}_${SUCCESS_SUFFIX}`);
        });
    });
    ...
    describe("getRequestError", () => {
        ...
        it("should have the expected type", () => {
            expect(action.type).to.equal(`${STATICHOTELS_GET}_${ERROR_SUFFIX}`);
        });
    });
});