...
import * as ActionCreators from "../../src/actionCreators/staticHotels_actionCreator";

describe("rooms_actionCreators", () => {
    const query = "iamquery";
    ...
    describe("get and success", () => {
        ...
        before((done) => {
            ...
            Sinon.stub(Axios, "get").withArgs(`${UrlConstants.STATICHOTELS_SEARCH}${query}`)
            ...
            ActionCreators.search(query)(dispatch).then(() => done());
        });
