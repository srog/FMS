...
import * as ActionCreators from "../../src/actionCreators/room_actionCreator";

describe("room_actionCreators", () => {
    ...
    describe("get and success", () => {
        ...
        before((done) => {
            ...
            Sinon.stub(Axios, "get").withArgs(`${UrlConstants.ROOMS_GET}${mappedRoomId}`)
            ...
            ActionCreators.get(mappedRoomId)(dispatch).then(() => done());
        });
